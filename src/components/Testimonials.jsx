...
import kaolad from "../assets/kaolad.png";
...
const cardsData = [
  ...
  {
    id: 8,
    icon: <img src={kaolad} alt="User Icon 8" />,
    name: "Olaide ",
    review:
      "JobJott is not just a tool; it’s a career coach that guides you through every decision.!",
  },
];
