          ...
          <div className="table-column-wrapper">
            <div className="ant-empty ant-empty-normal">
              <StyledEmpty
                description={
                  <div>
                    <p className="p1">You don't have any saved contacts.</p>
                    <p className="p2">
                      Save contacts by adding them manually to track your
                      applications.
                    </p>
                  </div>
                }
              >
                ...
                >
                  ...
                  <span className="addp1">Add contact</span>
                </Button>
              </StyledEmpty>
            </div>
          </div>
