    ...
    <div className="career-dashboard">
      ...
      <div className="hold">
        <section className="career-goal">
          <h2>
            Upcoming Career Objective: <strong>Secure a New Job</strong>
          </h2>
      ...
      <section className="task-list">
        ...
        <p>
          <strong>Progress:</strong> 0% Complete | 0 of 3 Steps Done
        </p>

        <div className="task">
          <h4> 1️⃣ Build Your Resume</h4>
          <p>
            Sync your LinkedIn profile, upload an existing resume, or use AI
            tools to design tailored resumes.
          </p>
        ...
        <div className="task">
          ...
          <p>
            Get JOBJOTT’s Chrome extension to bookmark jobs, save contacts, and
            organize company details.
          </p>
        ...
        <div className="task">
          ...
          <p>
            Easily save job listings through the Chrome extension or add them
            manually.
          </p>
